	...
	public function feed(
        ...
        foreach ($allLessons as $lesson) {
        	...
        	$icalString .= ""
                . "BEGIN:VEVENT\n"
                . "TRANSP:OPAQUE\n"
                . "DTSTART;TZID=Pacific/Auckland:" . $lesson->date->format(ICAL_FORMAT) . "\n"
                . "DTEND;TZID=Pacific/Auckland:" . $lesson->date->addMinutes($length)->format(ICAL_FORMAT) . "\n"
                . "DTSTAMP;TZID=Pacific/Auckland:" . $lesson->date->format(ICAL_FORMAT) . "\n"
